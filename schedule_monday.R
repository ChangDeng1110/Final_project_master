################# Monday ###################
set.seed(500)
temp_75_mid <- read.csv("temprature_all.csv")[c(25:73),]
...
ggplot(print_table_opt1, aes(time_data),na.rm=T,group=1)+
  geom_rect(aes(xmin=as.POSIXct("2017-06-28 09:00:00 AEST"),
                xmax=as.POSIXct("2017-06-28 18:00:00 AEST"), ymin=21, ymax=22, fill="Occupy"), alpha=1) +
  geom_rect(aes(xmin=as.POSIXct("2017-06-28 6:00:00 AEST"),
                xmax=as.POSIXct("2017-06-28 9:00:00 AEST"), ymin=21, ymax=22, fill="No-occupy"), alpha=1) +
  ...
  labs(title = "Monday (Schedule)", x = "Time", y = "Temperature (Celsius)",legend.text = element_text(size = 18))+
